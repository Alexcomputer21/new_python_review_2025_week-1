...
age = 25 # this is an interger
quantity = 3 # this is a interger
price = 10.99 # this is a float
...
# another rules is that variable names cannot have spaces
# another rules is that variable names
...
litters = 1.5
family = 10
print("I always bring a " + str(litters) + "litter" + drink + "for" + str(family) + "family members.")
print(f"I always bring a {litters} litter {drink} for {family} familly members.")
